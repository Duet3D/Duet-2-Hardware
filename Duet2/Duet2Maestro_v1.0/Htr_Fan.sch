...
F 2 "complib:SOT-23" H 2600 6250 60  0001 C CNN
...
AR Path="/50577A22/5090541F" Ref="#PWR079"  Part="1" 
F 0 "#PWR079" H 2750 7250 30  0001 C CNN
...
AR Path="/50577A22/50905416" Ref="#PWR080"  Part="1" 
F 0 "#PWR080" H 6600 4150 30  0001 C CNN
...
AR Path="/50577A22/5064BB75" Ref="#PWR081"  Part="1" 
F 0 "#PWR081" H 3300 4450 30  0001 C CNN
...
F 2 "complib:SOT-23" H 5400 6400 60  0001 C CNN
...
AR Path="/50577A22/5547E89A" Ref="#PWR082"  Part="1" 
F 0 "#PWR082" H 5550 7250 30  0001 C CNN
...
Wire Notes Line
	950  10625 950  7650
Wire Notes Line
	6100 10625 6100 7650
Text Notes 1000 7800 0    60   ~ 0
POWER MOSFET DRIVER
Wire Notes Line
	6100 7650 950  7650
Wire Notes Line
	950  10625 6100 10625
...
AR Path="/50577A22/568188CF" Ref="#PWR083"  Part="1" 
F 0 "#PWR083" H 3250 9950 30  0001 C CNN
...
AR Path="/50577A22/56943D05" Ref="#PWR084"  Part="1" 
F 0 "#PWR084" H 4000 8150 30  0001 C CNN
...
F 2 "complib:D-PAK" H 3150 3450 60  0001 C CNN
...
AR Path="/50577A22/56F6BC87" Ref="#PWR085"  Part="1" 
F 0 "#PWR085" H 10750 3900 30  0001 C CNN
...
F 2 "complib:D-PAK" H 6450 3450 60  0001 C CNN
...
F 2 "complib:D-PAK" H 10600 3400 60  0001 C CNN
...
F 2 "complib:SOT-23" H 8300 6400 60  0001 C CNN
...
AR Path="/50577A22/571B8014" Ref="#PWR086"  Part="1" 
F 0 "#PWR086" H 8450 7250 30  0001 C CNN
...
Wire Notes Line
	8625 9375 8625 7675
Text Notes 6275 7825 0    60   ~ 0
FAN Voltage Select
Text GLabel 7375 8575 0    60   Input ~ 0
V_IN
Text GLabel 7425 8325 0    60   Input ~ 0
V_FAN_A
$Comp
L CONN3 J3
U 1 1 571BF94A
P 7975 8325
F 0 "J3" H 7975 8125 50  0000 C CNN
F 1 "5V V_FAN_A  VIN" H 7975 8025 40  0000 C CNN
F 2 "complib:CONN_3x1" H 7975 8325 60  0001 C CNN
F 3 "~" H 7975 8325 60  0000 C CNN
	1    7975 8325
	1    0    0    -1  
$EndComp
Text GLabel 7425 8175 0    60   Input ~ 0
+5V
Wire Wire Line
	7425 8175 7525 8175
Wire Wire Line
...
U 1 1 5A179F82
P 4595 6665
F 0 "R75" V 4670 6673 50  0000 C CNN
F 1 "10K" V 4527 6677 50  0000 C CNN
F 2 "complib:R_0603" H 4595 6665 60  0001 C CNN
F 3 "~" H 4595 6665 60  0000 C CNN
	1    4595 6665
	-1   0    0    1   
$EndComp
Wire Wire Line
	4595 6465 4595 6400
Connection ~ 4595 6400
Wire Wire Line
	4595 6865 5550 6865
Connection ~ 5550 6865
Text GLabel 7360 9180 0    60   Input ~ 0
V_IN
Text GLabel 7410 8930 0    60   Input ~ 0
V_FAN_B
$Comp
L CONN3 J23
U 1 1 5A17AA25
P 7960 8930
F 0 "J23" H 7960 8730 50  0000 C CNN
F 1 "5V V_FAN_B VIN" H 7960 8630 40  0000 C CNN
F 2 "complib:CONN_3x1" H 7960 8930 60  0001 C CNN
F 3 "~" H 7960 8930 60  0000 C CNN
	1    7960 8930
	1    0    0    -1  
$EndComp
Text GLabel 7410 8780 0    60   Input ~ 0
+5V
Wire Wire Line
	7410 8780 7510 8780
Wire Wire Line
